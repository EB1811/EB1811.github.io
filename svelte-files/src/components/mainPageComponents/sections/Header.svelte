...
<header
  class="sticky top-0 z-50 border-t-4 border-emerald-400 bg-white shadow transition-colors duration-500 dark:border-indigo-700 dark:bg-neutral-800"
>
  <div class="container mx-auto px-6 py-4">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        <div class="invisible w-0 md:visible md:w-auto">
          <DarkModeToggle />
        </div>
        <a
          href="https://github.com/EB1811"
          class="mx-2 flex items-center text-gray-800 hover:text-emerald-500 dark:text-gray-100 dark:hover:text-indigo-500"
        >
          <svg
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
